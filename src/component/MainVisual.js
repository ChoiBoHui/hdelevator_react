...
const SLIDE = [
    { id: 1, content: <span>01 The world expands <br />along the new path created</span>, desc: "현대엘리베이터가 만든 새로운 길을 따라 세상은 위로 넓어집니다.", link: "https://my.matterport.com/show/?m=yEdf9FWaNav", title: "01 The world expands" },
    { id: 2, content: "02 The world expands along the new path created", desc: "현대엘리베이터가 만든 새로운 길을 따라 세상은 위로 넓어집니다.", link: "https://my.matterport.com/show/?m=yEdf9FWaNav", title: "02 The world expands" },
    { id: 3, content: "03 The world expands along the new path created", desc: "현대엘리베이터가 만든 새로운 길을 따라 세상은 위로 넓어집니다.", link: "https://my.matterport.com/show/?m=yEdf9FWaNav", title: "03 The world expands" }
]
